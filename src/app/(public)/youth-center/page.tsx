            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-bold text-sm uppercase tracking-wide">Layanan HKSR</span>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-blue-100 flex items-center justify-center text-blue-600">
                    <MessageSquare size={24} />
                  </div>
                  <span className="font-bold text-sm uppercase tracking-wide">Konseling Sebaya</span>
                </div>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-[14px] font-semibold leading-7 mb-12" style={{ color: c.blueText }}>
              ...
              Hingga saat ini, kami setidaknya telah menjangkau **17 Provinsi** di seluruh tanah air, memastikan akses informasi kesehatan tersedia bagi setiap remaja.
            </p>
          ...
          >
            ...
            >
              ...
              <p className="text-xs font-semibold leading-relaxed opacity-80 uppercase tracking-wider">
                Akses layanan kesehatan reproduksi yang ramah dan rahasia bagi remaja.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-xs font-semibold leading-relaxed opacity-80 uppercase tracking-wider">
                Belajar bersama melalui diskusi interaktif untuk membangun kesadaran HKSR.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-xs font-semibold leading-relaxed opacity-80 uppercase tracking-wider">
                Pengembangan potensi melalui berbagai kegiatan positif dan kreatif di Youth Center.
              </p>
            </motion.div>
          </motion.div>
        </div>
