          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-1 md:gap-4">
              ...
              <input
                ...
                type="text"
                required
                className="w-full flex-1 border-2 border-blue-400 rounded-xl p-2.5 outline-none focus:ring-2 focus:ring-blue-100 transition-all"
              />
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-1 md:gap-4">
              ...
              <input
                ...
                type="text"
                required
                className="w-full flex-1 border-2 border-blue-400 rounded-xl p-2.5 outline-none"
              />
            </div>
            ...
            <div className="flex justify-center md:justify-end pt-4">
              ...
              >
                {isUploading
                  ? "Memproses..."
                  : editData
                    ? "Update Berita Youth Center"
                    : "Simpan Berita Youth Center"}
              </button>
            </div>
          </form>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8">
        {listBerita.length > 0 ? (
          listBerita.map((item) => (
            <div
              key={item.id}
              className="group relative aspect-square bg-blue-900 rounded-[2.5rem] overflow-hidden shadow-md transition-transform hover:scale-105 active:scale-95"
            >
              <img
                src={item.gambar}
          ...
          <div className="col-span-full py-20 text-center border-2 border-dashed border-gray-100 rounded-[2.5rem]">
            <p className="text-gray-400 italic font-medium text-sm">
              Belum ada berita Youth Center yang ditambahkan.
            </p>
          </div>
        )}
      </div>
