...
export default async function AdminDashboard() {
  ...
  // --- FIX: WRAPPER UNTUK SERVER ACTION ---
  // Menghindari error tipe data karena form action mengharapkan return void
  ...
  return (
    <div className="min-h-full font-sans p-4 animate-in fade-in duration-500">
      ...
      >
        ...
        {/* MENGGUNAKAN handleUpdateAction SEBAGAI SOLUSI TYPE ERROR */}
        <form
