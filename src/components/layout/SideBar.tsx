      ...
      <div className="p-4 lg:p-6 flex items-center justify-center lg:justify-between relative">
        <div className="flex items-center gap-3 lg:flex-row flex-col text-center lg:text-left">
          <div className="relative w-10 h-10 bg-white rounded-full p-1 shadow-md">
            <Image src="/images/logo-pkbi.png" alt="Logo PKBI" fill className="object-contain p-1" />
          </div>
          <div>
            <h1 className="font-bold text-sm lg:text-lg leading-tight uppercase">PKBI JEPARA</h1>
            <p className="hidden lg:block text-[10px] opacity-80 font-medium">Klinik Pratama Wahana Sejahtera</p>
          </div>
        </div>
        <button onClick={handleLogout} className="lg:hidden absolute right-4 p-2 bg-white/10 rounded-full text-white">
      ...
      <div className="flex lg:flex-col overflow-x-auto lg:overflow-y-auto px-2 lg:px-4 gap-2 pb-3 lg:pb-4 scrollbar-hide">
        <Link
          ...
          className={`whitespace-nowrap flex items-center px-5 lg:px-6 py-2 lg:py-3 rounded-full font-bold text-[11px] lg:text-sm transition-all ${
            pathname === "/admin" ? "bg-white text-[#00387d] shadow-md" : "text-white hover:bg-white/10"
          }`}
        >
          DASHBOARD
        </Link>
        ...
        <Link
          href="/admin/layanan"
          className={`whitespace-nowrap flex items-center px-5 lg:px-6 py-2 lg:py-3 rounded-full font-bold text-[11px] lg:text-sm transition-all ${
            pathname === "/admin/layanan" ? "bg-white text-[#00387d] shadow-md" : "text-white hover:bg-white/10"
          }`}
        >
          LAYANAN
        </Link>
        ...
        <div className="flex flex-col w-full">
          <button
            ...
            className={`whitespace-nowrap flex items-center justify-between px-5 lg:px-6 py-2 lg:py-3 rounded-full font-bold text-[11px] lg:text-sm transition-all ${
              pathname.includes("/admin/berita") ? "bg-blue-600/50 text-white" : "text-white hover:bg-white/10"
            }`}
          >
            <span>BERITA</span>
            <ChevronDown className={`w-3 h-3 transition-transform duration-300 ${isBeritaOpen ? "rotate-180" : ""}`} />
          </button>
            ...
            <div className="bg-[#002859] rounded-2xl py-2 mx-2 space-y-1">
              <Link
                ...
                className={`block px-6 py-2 text-sm font-medium transition-colors border-l-4 ml-2 ${
                  pathname === "/admin/berita/klinik" ? "border-blue-400 text-blue-200 bg-white/5" : "border-transparent text-gray-300 hover:text-white"
                }`}
              >
                KLINIK
              </Link>
              <Link
                ...
                className={`block px-6 py-2 text-sm font-medium transition-colors border-l-4 ml-2 ${
                  pathname === "/admin/berita/kartini" ? "border-blue-400 text-blue-200 bg-white/5" : "border-transparent text-gray-300 hover:text-white"
                }`}
              >
                KARTINI
              </Link>
        ...
        <div className="hidden lg:block mt-auto pt-4 border-t border-white/10">
          <button onClick={handleLogout} className="w-full bg-white px-6 py-3 rounded-full font-bold text-[#00387d] flex items-center justify-center gap-2 shadow-lg hover:bg-gray-100">
        ...
        <div className="lg:hidden flex justify-center gap-4 bg-[#002859] py-3 border-t border-white/10 animate-in slide-in-from-top-2 shadow-inner">
          <Link
            ...
            className={`text-[10px] font-bold px-5 py-2 rounded-full transition-all ${
              pathname === "/admin/berita/klinik" ? "bg-white text-[#00387d] shadow-md" : "text-blue-200 hover:bg-white/5"
            }`}
          >
            KLINIK
          </Link>
          <Link
            ...
            onClick={() => setIsBeritaOpen(false)}
            className={`text-[10px] font-bold px-5 py-2 rounded-full transition-all ${
              pathname === "/admin/berita/kartini" ? "bg-white text-[#00387d] shadow-md" : "text-blue-200 hover:bg-white/5"
            }`}
          >
            KARTINI
          </Link>
